        ...
        <div className="clips-container">
            <div className="clips-flex">
                    <div className="clips-div1">
                            ...
                            <img src="https://i0.wp.com/batman-news.com/wp-content/uploads/2015/12/Batman_singing.jpg?fit=1200%2C669&quality=80&strip=info&ssl=1" alt="" />
                    </div>
                    <div className="clips-div2">
                            <div>
                                <h3>Superman & Batman vs Darkseid | Justice league Unlimited</h3>
                    ...
                    <div className="clips-div1">
                    <img src="https://i.ytimg.com/vi/TlVauMtPgTs/maxresdefault.jpg" alt="" />
                            <div>
                                <h3>Batman risks it all in his best scene | Justice League Unlimited</h3>
                    ...
                    <div className="clips-div2">
                    <img src="https://i.ytimg.com/vi/vjKMHqCDdD8/maxresdefault.jpg" alt="" />
                            <div>
                                <h3>The Flash turns back time | Zack Snyder's Justice League</h3>
            ...
            <div className="clips-flex">
                <div className="clips-div2">
                <img src="https://cdn3.whatculture.com/images/2019/12/54ae444f2b3c9e33-600x338.jpg" alt="" />
                        <div>
                            <h3>Supermans First Flight | Man Of Steel</h3>
                ...
                <div className="clips-div1">
                    <img src="https://i.ytimg.com/vi/EX3O40xOy04/maxresdefault.jpg" alt="" />
                            <div>
                                <h3>Aquaman (2018) - Aquaman vs. King Orm Scene</h3>
